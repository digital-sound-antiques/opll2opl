...
exports.OPLL_RAW_VOICES = [
    ...
    new Uint8Array([0x01, 0x01, 0x18, 0x0f, 0xdf, 0xf8, 0x6a, 0x6d]),
    new Uint8Array([0x01, 0x01, 0x00, 0x00, 0xc8, 0xd8, 0xa7, 0x68]),
    new Uint8Array([0x05, 0x01, 0x00, 0x00, 0xf8, 0xaa, 0x59, 0x55]),
];
function rawVoiceToVoice(d) {
    return {
        mod: {
            am: (d[0] >> 7) & 1,
            pm: (d[0] >> 6) & 1,
...
exports.rawVoiceToVoice = rawVoiceToVoice;
var OPLL_VOICES = exports.OPLL_RAW_VOICES.map(rawVoiceToVoice);
exports.default = OPLL_VOICES;
